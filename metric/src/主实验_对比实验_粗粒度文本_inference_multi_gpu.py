...
# model_type = "t5"
model_type = "CFP_C"
# base_file = f"./data_comparison/eval_images_coarse-graied_{model_type}.csv"
base_file = f"./data/eval_images_coarse-grained_20_ans_5.csv"
...
def pipe_rum(id, raw_data, pipe, g, device, height=512, width=512, step=50, cfg=7.5):
    ...
    for idx in range(0, 1):
        ...
        prompt_list = ast.literal_eval(raw_data["coarse-grained prompt"])
        prompt = pre_caption(prompt_list[1]["prompt"])
        # print(prompt)
        # ["prompt"]
...
if __name__ == "__main__":
    ...
    with open(f"data_coarse_prompt_output_pic/{model_type}_multi_gpu_{gpu_id}.csv", "w", newline="") as file:
