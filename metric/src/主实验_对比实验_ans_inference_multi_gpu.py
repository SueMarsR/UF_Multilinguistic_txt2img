...
def pipe_rum(id, raw_data, pipe, g, device, height=512, width=512, step=50, cfg=7.5):
    ...
    for idx in range(0, 1):
        ...
        output = f"./data_comparison_model_output_pic/{model_type}_{idx}/{img_name}.png"
        image.save(output)
    # print(seed)
    return dic
...
if __name__ == "__main__":
    ...
    with open(f"data_comparison_model_output_pic/{model_type}_multi_gpu_{gpu_id}.csv", "w", newline="") as file:
