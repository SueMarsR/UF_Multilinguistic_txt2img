...
base_file = "./data_comparison/eval_chatgpt_gpt4.csv"
model_type = "gpt3-5_v2"
gpu_id = 2
...
def main(pipe, g, device):
    ...
    with open(f"model_output_pic/{model_type}.csv", "w", newline="") as file:
